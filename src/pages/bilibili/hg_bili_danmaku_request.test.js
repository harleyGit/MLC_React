...
import { buildVideoDanmakuCreateBody, buildVideoDanmakuListQuery, buildVideoDanmakuSocketCommand } from "./hg_bili_danmaku_request.js";
...
test("danmaku websocket command reuses the HTTP create contract", () => {
  const body = buildVideoDanmakuCreateBody({ videoId: "VID_1", content: "hello", requestId: "REQ_1", progressMs: 1200 });
  assert.deepEqual(buildVideoDanmakuSocketCommand(body), { type: "danmaku.create", data: body });
});
